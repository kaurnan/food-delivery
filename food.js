...
function displayItems(){
    ...
    var chappati=  document.getElementById('chappati');
    ...
    const chappatiData= foodItem.filter((item)=>item.category=='chappati');
...
document.getElementById('ca').addEventListener('click',cartToggle);
...
// document.getElementById('ab').onclick=function() {myFunction()};
document.getElementById('ab').addEventListener('click',myFunction);
function myFunction(){
    document.getElementById('food-items').classList.toggle('food-items');
    document.getElementById('category-list').classList.toggle('about');
    document.getElementById('cart-page').classList.toggle('about');
    // document.getElementById('food-items').classList.toggle('about');
    document.getElementById('about').classList.toggle('about');
    document.getElementById('abou').classList.toggle('about');
    // document.getElementById('about').classList.toggle('about');
    // document.getElementById('checkout').classList.toggle('cart-toggle');
}
// let Abo=document.querySelector('about')
// let Abu=document.querySelector('ab')
// Abu.onclick =()=>{
// //     Abu.classList.toggle('about');
// //     }
// // function About(){
...
// let meenu = document.querySelector('#container #menu .menu-item');
// let menuBtn= document.querySelector('#menu-btn');
// menuBtn.onclick =()=>{
//     // menuBtn.classList.toggle('fa-remove');
//     meenu.classList.toggle('active');
// } 